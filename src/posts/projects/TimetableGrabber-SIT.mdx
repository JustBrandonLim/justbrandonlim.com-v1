...
time that could be used for other meaningful purposes.

### About TimetableGrabber - SIT

**TimetableGrabber - SIT** is a tool that allows you to grab and export your trimester's timetable
to the _.ics_ format where you can import it to your favourite calendar.
...
since it was automated and I am able to hide the browser with **headless Chrome**.
...
After scraping the data, I then used a library called **[ical.NET](https://github.com/rianjs/ical.net/)** to export
